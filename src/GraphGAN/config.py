...
train_filename = ["../../data/" + app + "/" + dataset + "_train0.txt",
                  "../../data/" + app + "/" + dataset + "_train1.txt",
                  "../../data/" + app + "/" + dataset + "_train2.txt"]
...
emb_filenames = ["../../results/" + app + "/" + dataset + "_gen0_.emb",
                 "../../results/" + app + "/" + dataset + "_dis0_.emb",
                 "../../results/" + app + "/" + dataset + "_gen1_.emb",
                 "../../results/" + app + "/" + dataset + "_dis1_.emb",
                 "../../results/" + app + "/" + dataset + "_gen2_.emb",
                 "../../results/" + app + "/" + dataset + "_dis2_.emb"]
result_filename = "../../results/" + app + "/" + dataset + ".txt"
cache_filename = "../../cache/" + dataset + ".pkl"
test_label_filename = "../../results/" + app + "/" + dataset + "test_label.txt"
model_log = "../../log/"
